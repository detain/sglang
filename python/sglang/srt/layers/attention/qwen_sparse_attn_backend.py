    ...
    def _metadata_from_forward_batch(self, forward_batch) -> QwenSparseAttnMetadata:
        ...
        if (
            ...
            if prefill_all_visible:
                ...
                # Stack note: reuse the MRoPE-normalized (row-0) logical
                # positions instead of flattening a possible [3, tokens] tensor.
                query_positions = ring_logical_positions
                (
                    prefill_row_starts,
                    prefill_row_ends,
