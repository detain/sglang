...
class Envs:
    ...
    # Select the QSA chunked-prefill KV source. Auto keeps the packed gather
    # path; paged reads the KV pool through req_to_token without densifying.
    SGLANG_QSA_CHUNK_PREFILL_KV_SOURCE = EnvStr("auto")
